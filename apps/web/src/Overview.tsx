...
export function OverviewContent() {
  ...
  const { start: startTour } = useOverviewTour({ selectedScenario, activeScenario })
  ...
  return (
    <>
      ...
      <PaymentsPageMain>
        ...
        <section className="overview-actions" id="overview-quick-actions" aria-labelledby="quick-actions-title">
