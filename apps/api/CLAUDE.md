...
> This file is `CLAUDE.md`, not `AGENTS.md`, on purpose. The notebooks and
> scripts find the repository root by looking for the nearest `AGENTS.md`, so an
> `AGENTS.md` inside `apps/api` would break them when they run from this folder.
